...
function previewSvg(theme) {
  ...
  <text x="600" y="61" text-anchor="middle" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="13" fill="${theme.foreground}" opacity=".72">termdeck — ${escapeXml(theme.slug)}</text>
  <text x="86" y="130" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="15" fill="${p[6]}">┌── termdeck/theme</text>
  <text x="86" y="170" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="26" font-weight="700" fill="${theme.foreground}">${escapeXml(theme.name)}</text>
  ...
  <text x="184" y="286" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="16" fill="${p[3]}">"${escapeXml(theme.slug)}"</text>
  ...
  <text x="1116" y="610" text-anchor="end" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="12" fill="${theme.foreground}" opacity=".5">${escapeXml(theme.background)}  ${escapeXml(theme.foreground)}  ${escapeXml(theme.cursor)}</text>
</svg>`;
}
