...
- Added a project-scoped, read-only Kiro reviewer and a checked, session-aware workflow for independently auditing staged changes and completed checkpoints.
